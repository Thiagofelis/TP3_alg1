...
with open('dados_t1.csv') as file:
...
out = open('graficos e dados/tempo_t1.csv', 'w')
...
plt.grid()
plt.savefig('graficos e dados/valores_tempo_t1.pdf')
plt.clf()
...
plt.grid()
plt.savefig('graficos e dados/stdev_tempo_t1.pdf')
plt.clf()
...
plt.grid()
plt.savefig('graficos e dados/valores_saida_t1.pdf')
plt.clf()
...
plt.ylabel("Desvio padrao percentual [%]")
plt.grid()
plt.savefig('graficos e dados/stdev_saida_t1.pdf')
plt.clf()
